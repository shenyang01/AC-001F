...
public class CustomCurveChart extends View {
    ...
    public void init() {
        ...
        xScale = (this.getWidth() - 2 * margin - marginX) / (xLabel.length - 2);
        ...
        paintTable.setColor(ContextCompat.getColor(getContext(), R.color.color3));
...
//        }
        ...
        // 纵向线
        for (int i = 0; i * xScale <= (this.getWidth() - margin); i++) {
